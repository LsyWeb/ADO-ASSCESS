...
function renderTable(data) {
    var str = data.reduce(function (pre, ele, index) {
        ...
        <td>${ele.address}</td>
        <td>
        <button class="edit-btn btn btn-success redact" data-toggle="modal" data-target="#editMessage" data-index=${index}>编辑</button>
        <button class="remove-btn btn btn-danger remove" data-index=${index}>删除</button>
        </td>
    </tr>`;
    }, "");
